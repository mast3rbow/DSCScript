...
param(
    ...
    [Parameter(ParameterSetName='AssociatedParameterSet')]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Body')]
    [System.Management.Automation.SwitchParameter]
    ${AssociatedOnly},

    [Parameter(ParameterSetName='UnAssociatedParameterSet')]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Body')]
    [System.Management.Automation.SwitchParameter]
    ${UnAssociatedOnly}
)
...
begin {
    try {
        ...
        $mapping = @{
            DefaultParameterSet = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Find-CsOnlineApplicationInstance';
            AssociatedParameterSet = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Find-CsOnlineApplicationInstance';
            UnAssociatedParameterSet = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Find-CsOnlineApplicationInstance';
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCLPCKm5Ln6mgvs
# iTsaPZVOkeDBzxqHska4FXBROTwlk6CCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINPNjhvEmunUKjM/VEx0/sf1Utb3
# JfbUTdacAbTSOvvmMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAINyxPci
# DFcajIUpTGu3MlVilnY7LLKDj+y3BjoZFtGzjfnZ2etXnmZkQV9lTC+8ubKbYlGp
# 5z22wdoRcRbOz4cTXf3FZyvjJqLSvyrhLWLtAjHz+sNDpQwFQ1tioZYPO27UfgRS
# 43XSW4bWwogKkXqIIcV80Y/3pphA3opQZvvdiX8fenf+5xziqo+PNFhRl7if49UR
# gZ1DB3brIr3lD1rgLlKof/P+lK5DhCAybSSlogv7q0axKbtsu+uGnEGANPdVefT2
# AElnqRsDfUjczfajr444aQqBCEN6GTzW9y0B+nfH+d211uOAMAmA9y9W6AMPU2dx
# cqgUJKCDA0FEqQehghcZMIIXFQYKKwYBBAGCNwMDATGCFwUwghcBBgkqhkiG9w0B
# BwKgghbyMIIW7gIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBWQYLKoZIhvcNAQkQAQSg
# ggFIBIIBRDCCAUACAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgwp9F
# iQdFNUaBPM/YVTsrbkukp88EuP1OLrM0nMpDDeACBmHCHy8jPhgTMjAyMjAxMjEw
# ODQzNDMuNzMzWjAEgAIB9KCB2KSB1TCB0jELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgdhPJC9YMLOD59o7TGg/HauvB1i4YNJPf
# OudXR/7fObkwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBm6d7trAY3RoSC
...
# PT4cd2d0c5hDLdK1tNzOtbZDh7y5MA0GCSqGSIb3DQEBCwUABIICAIkgBI08yrI6
# 2fSGUR2ymgpXdQlpkybF62fEYdmPB+4ZM6pqddGrKUtiC6QAiidL0QqWi0cvdoBv
# mfjtXYyUSXKtVhGgwW9HbyN/F6hN/4XfX4+s2oJbC+duJvuEgpABCDPrS417d3zF
# ahxJecmTD4LeMq7Zlpc+aUhdKiQZ6wDnpOPBrNtQBlUzh5oPHSAPt2ntlBu80MG8
# 50SUL9SmgBSWlqwMMmIF3DPCtnHI/ivAQwPfOlbF79eGeDtLjCglK9mc/j60Eygl
# wtGVpzsNiO50RPIDRZVsapEKNR3bTALF+O/5xguV2HvpEK5wX/SnvRVtKxC+Z6gG
# oD3PVMl/jfq5aS7/jvSRDm323GBM8YtnA+p3T0VMUpqgrUIjQAHwq8kNEXY9o3mH
# SNG4LGQ/hY5wszHsEaXrHLnw/RFyQioexD6owGxIVYg7OUqN5jYN92mwBjfddW9X
# gMtCth8VbDluoN1PCiHw/cwP7G3tpqeoB1FMLd9pcihjPS+p2YvvD6dzTRxhxLrA
# 29HbaSjUDgQtVER53Q2nMyV6wLBY42BBfXKebm+mNqNUMPKPrAlD3fdXxvAKtwXU
# wQEa78/674TUd723kqzVqqT0rqgId15VSsEe12erVlKIFrFHg3JsH+bv8veyzGM6
# RhoO3pEuPByLOBSIJ30EnvISQrbONyCH
