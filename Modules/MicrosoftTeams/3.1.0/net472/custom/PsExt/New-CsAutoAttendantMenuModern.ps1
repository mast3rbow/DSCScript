    ...
    process {
        if ($Prompts -ne $null) {
            ...
            foreach($prompt in $Prompts) {
                $inputPrompts += [Microsoft.Rtc.Management.Hosted.OAA.Models.Prompt]::CreateAutoGeneratedFromPsObject($prompt)
            }
        ...
        if ($MenuOptions -ne $null) {
            ...
            foreach($menuOption in $MenuOptions) {
                $inputMenuOptions += [Microsoft.Rtc.Management.Hosted.OAA.Models.MenuOption]::CreateAutoGeneratedFromPsObject($menuOption)
            }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBostyHJU+8VEqq
# UhrspF6u1fpwEp2xHNs+hlQ3HRm1BqCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIM43axXkBE06qKLW2rjasNeMDD3Q
# /hE+phr2FuIrEnJwMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAEPmot34
# bujflmErTG0xsDlusfoiYz7i42aziE/VOMpNLkMtgEP9o7mLXJzYwiMReGVgqZVL
# u9zNJesVfbKVnNiAwonegi5oBnbqE9mAPzU+23dlXTS9BAKP6dnOjiGDSfL9F9SY
# honqATwe2f4Rwha0F3akX3GLVcyVKmRKmVsc1Fum9skrVWhKK0iGp3Goxbhi7sJe
# PHQKomiMACEQ/GOZ/nvBjmYUyxTEHv02Fu6a18GbIObXCgJiNhaTsjn1AgqEjoO1
# 8UsEmDyx9tKcqpaoY7KMArFRvZNHDU9tz2Ths8RsPFX3xGnirSmniYFV1Nk16S7v
# bgJUnxhidnEeWG6hghLlMIIS4QYKKwYBBAGCNwMDATGCEtEwghLNBgkqhkiG9w0B
# BwKgghK+MIISugIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgm9Fm
# Zq45CVAu/3yE/IJV1Rfql9tcVddjnwfm2heiS6YCBmHloeC6ShgTMjAyMjAxMjEw
# ODQzNDQuOTA4WjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# EAEEMC8GCSqGSIb3DQEJBDEiBCCGADdxEtun4PZPbI6l+IEoQWBfvmS1t/Pl3cx8
# ipWJXjCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIKmQGuqMeaG/Jh/m1NxO
...
# gK8FvkwGdoZMrTfE1RPMsiwwDQYJKoZIhvcNAQELBQAEggEAxkDawrOjqF6BmGJb
# 1F1MLV85i4ehBDbtsTNvbosBhA6GpzpL3GInFLOluVgAmC1eDbcDZuCLltMRr73u
# UQJI85FNv91SIve2p5Lh5Bs3pBbeokDHV/e1F+tfNvMW/ISXimDpgBCy8keXZcMz
# f0pJ12Pe4BiD9HhhWc5kKdkZQPYffxzAWBmVQqEaSiBuVOr7HGIZVNaOrIhSse2f
# fEmu7w3Q2W7T87ztnDcluFU0YI3dLpWwR5N0AuiR8eCz1vRntZ9vgICZqZo6AH/n
# fXCMlwQHFCzEmMoRwu/9hsDp5yhedkNOkZ+C6Dhd8Huk6/YWoXcOf6huzXjeZFKF
# ar1Gng==
