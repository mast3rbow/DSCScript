...
function Get-CsConfigurationModern {
    ...
    process {
        ...
        $xdsConfigurationInput = Microsoft.Teams.ConfigAPI.Cmdlets.internal\Get-CsConfiguration @HashArguments
        $formatTypeName = Get-FormatData -TypeName ('Deserialized.Microsoft.Rtc.Management.WritableConfig*.' + $ConfigType)
        foreach ($configInst in $xdsConfigurationInput) {
            $nob = new-object PSCustomObject -Property $configInst.AdditionalProperties
            $nob | Add-Member -MemberType NoteProperty -Name 'Identity' -Value $configInst.Identity

            if($formatTypeName -ne $null)
            {
                $nob.PSTypeNames.Add($formatTypeName.TypeNames)
            }
            
            $xdsConfigurationOutput += $nob
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCtwrr/4NRwqsa9
# 7oJrFbloszs7f5faZDx2N4TMPKlS26CCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOIsSiJCsAOb7D+aftCr1/B6nvSH
# fiQhKhy2J7ecOKbSMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAFjg4wsW
# tGKjwvSigWcEVo7B3DncCW8O2BOPiO7/g5xe+4g+LbSlIMwK7VBoP5lwXn/Sat7P
# 9tH4gyqTuplj0JkYfCnuqCzfJeMCjSjnMAtnyK9s1D8oqzAohDUOotKOG0sOHqKK
# pxO9Tm6CKUW9VbCp4VI5R7DUG2EE8NmJqrZ8ffqvO+pd2LBHP+YDTnN297xTrIxZ
# DeFfv9NRq7YYAnnR+2XxKEw7BPYEZWl6GbAKihcWIAJJ7d/9z70L9ME82Yspq6hM
# sy26i0DLNcbqyCUcGLHUbZaKHUcYyWYSOuEtsI/cfM/Vqa1qgomX1azhKMLn+Q/9
# 309qRSJ7ZjW8/7ShghcZMIIXFQYKKwYBBAGCNwMDATGCFwUwghcBBgkqhkiG9w0B
# BwKgghbyMIIW7gIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBWQYLKoZIhvcNAQkQAQSg
# ggFIBIIBRDCCAUACAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgBO0Q
# /gl7v2ze0HyUexGmZN3tIXS7DgBaqji3i/Lz2u0CBmHCHy8iyhgTMjAyMjAxMjEw
# ODQzMzUuNTMzWjAEgAIB9KCB2KSB1TCB0jELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgRboUQ2Dz/sGP7Y4z21OnZpCVSXl7vVoW
# qMnG1qPRSXowgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBm6d7trAY3RoSC
...
# PT4cd2d0c5hDLdK1tNzOtbZDh7y5MA0GCSqGSIb3DQEBCwUABIICAA/6U3NgFyt0
# ySXRJvR3S4pC2/4LUlrYd7vXWvptziGEORy3kxaML0f3Brida2Qu5a0Zoiz7ctFQ
# +/Urcd677h/tvDNdLY1VjGVqG7Ye1mSBXYGGHt0vxPzFi2M62blJlfcSJEKzqphc
# IeWla11fK8KF8iuaYZw7rHIclcH1Z8uH5Keoh8IjgQTCC0P1o+AyEMc7a4gcOmYL
# ANDJA3C4QArcrG2ggYkNDxzN7Ll4oTy3f2QUbFMv2dBeX7nQikilHoxW5cq4t8Xf
# WlJFsNm7ifIONKwNMmPhF35urdWX8CFj29IZ9DIbpS8+jANNL7vYLOQrsTUVDXg6
# WOI7iUAsaGWFM1HFVbpysdxbm6eSqpTVUGBobg0Xsj/n7FUD0buEOS+VMO7r2lYc
# 1DqMNHAT5uvN6848Q7oMecOvd+WYYHfIJQy9yboeRrh6VPpxT9aUvAP1GgLhARhV
# 4/KR8wBBjetDo9vewRryobSK3MdwCEmIrvKQ5G5ddvVlbaiXK+7df3cTb4dQJGQQ
# WnICczF91EqsKWrT5XNbgOlYZDsdS+hWlIb2IYojgJj8kCEVaSncEe1Ej4nRfRmH
# mTubWLeedF+W4J4sFmwtHh9IXGMCwyvKuCarnVrE0yXNwhDcKyN1B4beMKdEKYV+
# owskeCxy/s2LrJ/t82jmpGCggcn0vTMP
