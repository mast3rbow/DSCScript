...
function New-CsConfigurationModern {
    ...
    process {
        ...
        Microsoft.Teams.ConfigAPI.Cmdlets.internal\New-CsConfiguration -ConfigType $ConfigType -Body $PropertyBag
        #Get the configuration with Identity passed in $PropertyBag and return
        #Todo: Ensure to test this under TPM, given we are referring the Microsoft.Teams.ConfigAPI.Cmdlets module
        Microsoft.Teams.ConfigAPI.Cmdlets\Get-CsConfigurationModern -ConfigType $ConfigType -Identity $PropertyBag['Identity']
    }
}
# SIG # Begin signature block
# MIIjcAYJKoZIhvcNAQcCoIIjYTCCI10CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBuzQ0U7ft1VVRM
# +d3aDwZgEfG2s3BfUCZ8USsvQIA8gqCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDx/NVLVlmOIs+ODShBicmEPQOPz
# s5o3qlmlH3lhmRajMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAJCd+Uiz
# Qi9ZGv/OrEhsUcHe7mmioeE5IEkKuFbm4lUEVplLPv1y0TJNUiEV8Brea5L63bMa
# 6ZEn8bek7HU/8yugFtZi8xSj1OOCNq40vuM4hHUUM2jttxnvd9RS73Qye9YVKI76
# OaGP2FIJdeem37OvG+0tM8by0roTG1VH6eZ+NrAyGwl1LyEU1xEPkw7A5lnWRgJm
# qs9d4I/FF5v7Bum3N1rs1Qyfe4ET1LsPj0jByZoOxOK0IESMWcehogNVMIJYjYjb
# AHdtaEtJvXKZkzOvE7N2nMSThYQC9sa/x0fa/xbNfVX7qqhB3LxvKlWp6La9XnGS
# M2cCxfQ7U3zv/IahghLlMIIS4QYKKwYBBAGCNwMDATGCEtEwghLNBgkqhkiG9w0B
# BwKgghK+MIISugIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgouBN
# PfQtQKqbSaSYo4QqnRzTrVM40FcnYAVWbcAdrZMCBmHloeC4TxgTMjAyMjAxMjEw
# ODQzMzQuMTM3WjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# EAEEMC8GCSqGSIb3DQEJBDEiBCAZvG4WoLfQ412Q8urA0iKWP2dKKC6QkJFz4wAJ
# xWQF9DCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIKmQGuqMeaG/Jh/m1NxO
...
# gK8FvkwGdoZMrTfE1RPMsiwwDQYJKoZIhvcNAQELBQAEggEAiyg53t0QGjV3uo3e
# 9ujSsVXTW5JbYM9RSYviAH0ZDCEYdFXGjmYan6Iym2Pp2xBSNQRlmhvtRZUamIEt
# Wi0ZsDTNHhJt6AkSYLrVQm7mrkr8HE0PQpiOqk0LrCfKEA/0PsGWtAUnSschyXu8
# AM544E1XDE4skJthwIJU7zd1AiCx0OhBOUlnlJ1P/s1XZg493blYmBiM6zqGenBs
# 5oU1FK9WU/u8ZgpojG/RO9iadUbx35Qj/nPPqfXvWXijomJYGqILtRZ0CeGValdW
# CFRjHDcubu1a+tCQnPeTvUkTXqoq+8cWzZyAFYareuavBYPV3a02lyEq7xXNmcOn
# +iF1bg==
