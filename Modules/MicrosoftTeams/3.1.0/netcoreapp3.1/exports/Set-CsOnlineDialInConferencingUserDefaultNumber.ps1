...
[CmdletBinding(DefaultParameterSetName='BridgeNameParams', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory)]
    [ValidateNotNull()]
    ...
    [Parameter(ParameterSetName='FilterByUsageLocation')]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Body')]
    [System.String]
    ${BridgeName},

    [Parameter(ParameterSetName='BridgeNameParams')]
    [Parameter(ParameterSetName='FilterByUsageLocation')]
    [ValidateNotNull()]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Body')]
    [System.String]
    ...
    [Parameter(ParameterSetName='BridgeNameParams')]
    [Parameter(ParameterSetName='FilterByUsageLocation', Mandatory)]
    [ValidateNotNull()]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Body')]
    [System.String]
    ${CountryOrRegion},
...
begin {
    try {
        ...
        $mapping = @{
            BridgeNameParams = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Set-CsOnlineDialInConferencingUserDefaultNumber';
            FilterByUsageLocation = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Set-CsOnlineDialInConferencingUserDefaultNumber';
            UniqueBridgeParams = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Set-CsOnlineDialInConferencingUserDefaultNumber';
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC4SMUN5/IJSvWO
# wKMA841K9aZoFOdCwkzHtAf+pSrWSqCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGC817jzJViev3BtfKm/l62cmKfq
# ChpZF+8FIRMVQJpFMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAGX4YSIA
# mQxnwOVlOx9zmDxCOacM7US5VVU20mtESjv68Nic8OKIC3yvxKI5cMIeucK/Ir6i
# ihnKAlvTmU3Vi6VLWStd4Z56DckQXu+GHCuY9l29fI+MlbrzZpw4HTzF/tEl/tPB
# F0qMe1UbnTHgbQi/sbNc35ggSeijsk2VyAF6PQ/ihNh2iYVHv905jqxgUjsnoqIP
# nw1K5v9jTqTdeUMoAOxsIItpKfiTo9K3kyAzu4DIUH/+ZvvVrpPiUAWs5C7LIql3
# kZ+mbJkchq2jdwSc3XU/O/sZWPsNLsqNmlCsSOVnjJ283NjUG/l5QjdYtB6i1M4J
# mqOLIFp89dy/9MmhghcYMIIXFAYKKwYBBAGCNwMDATGCFwQwghcABgkqhkiG9w0B
# BwKgghbxMIIW7QIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBWAYLKoZIhvcNAQkQAQSg
# ggFHBIIBQzCCAT8CAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgleXR
# JFhfdGk/CgVV5WxPOlCpvGhUGhVbMLAJlHrxi30CBmHCHy8jCBgSMjAyMjAxMjEw
# ODQzMzguOTVaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJVUzETMBEGA1UECBMK
...
# DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDsqLnNSpL2Le01/XQuF3pfpohRHEdgO+6J
# omsSntiscTCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIGbp3u2sBjdGhIL4
...
# Phx3Z3RzmEMt0rW03M61tkOHvLkwDQYJKoZIhvcNAQELBQAEggIAGwuLIaxOG4Rz
# 86oAsUmQtDh3doGopnxtprDwe9bx/tDDD/ARZ6n6nu+SNRz6eRcq7J7Npxxr5OEa
# cAhCT0h/X/TzwYlwS/X7u5Lp8ir/+SR/WltNxRLOTenTVDkE1rdwnmMj8QHsxKgt
# rqjbKvdT63ZoO3uaMeWdHGCqC1UzT7L56dNXBQapvRf1Z+HFs2nk03dfys9A9/XL
# dBsi0kbfmcE1YGiD6aBeF0ZrxndS7RL2XQpCIJfpfKA/byjjgcmhER0KPKI+bn8E
# DaVDbMsLeeWxb+5QuL1mhZwF9YoC2pPRL+k51HlFrXFjcCwlMUV8MR9mpDBaZbCq
# J0NqpJc2NUHjCdq9MYubFfVSvgxxS2lNcc9DHTci0AtxwEDuz1EVFcwipK7F8mmu
# 8+XfVk5nNQsYkROAJzD1tkgaRJZEWfQMRAfq+q40wy9pzNoNxHTM8XuTljc3AJm9
# 5u99HjHGFbRlQ9xgGwyknnWxOoHoRWbqdMxJiM1dif5bFoMzrKfSMapwIMo9W+u5
# xTNjk8kT4/rNkm4A4l93iUq+FcuVfSp0cyXGtC7MK4dkIeAKM4kLsnRQ0uIxdKyN
# tcrrofNy7bE2gFfifAU51xDsW3ZGCmLyJyDAwKnutTWp/Qgt3lhDl8PQCS7AJU18
# I8qneTHrGorpEvc1lMA3mMS8Wvk55/4=
