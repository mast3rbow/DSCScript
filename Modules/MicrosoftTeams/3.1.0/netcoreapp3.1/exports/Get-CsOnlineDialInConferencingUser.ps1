...
[CmdletBinding(DefaultParameterSetName='EmptySet', PositionalBinding=$false)]
param(
    [Parameter()]
    ...
    [Parameter(ParameterSetName='BridgeNameParams', Mandatory)]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Body')]
    [System.String]
    ${BridgeName},

    [Parameter(ParameterSetName='IdentityParams', Position=0, Mandatory)]
    [ValidateNotNull()]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Body')]
    [System.String]
    ${Identity},

    [Parameter(ParameterSetName='UniqueNumberParams', Mandatory)]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Body')]
    [System.String]
    ${ServiceNumber}
)
...
begin {
    try {
        ...
        $mapping = @{
            EmptySet = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Get-CsOnlineDialInConferencingUser';
            UniqueBridgeParams = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Get-CsOnlineDialInConferencingUser';
            BridgeNameParams = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Get-CsOnlineDialInConferencingUser';
            IdentityParams = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Get-CsOnlineDialInConferencingUser';
            UniqueNumberParams = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Get-CsOnlineDialInConferencingUser';
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAeiswAPF46LqJD
# nOZpL61sxg7DeldrnH4vy9yXkdDNr6CCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJUEmfisgdkMpEXNGin83abcXmcp
# dMQ/KwLEJrqarC5RMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBADaXSw3Z
# +OUID+eHDbALVYyrObtp0XhRdXVmVhf+rSyl4Qem5e3VwR/zvkUlaA/+sYLNJ4sX
# E2UY/2T7wWTfiWRf/tGQvk+wL62BVL32tKWXb3UVTZMlwrobtY3sIKu4eoCOPyez
# 1MZuOcpPorYZ5WXR6bd4n7aE61jir/eLz7WUBSAUw0YpmU5hJrOVdU5h4+gpZr3d
# e3Rh/IkYwSblGtGXIY27HBbSS+yk6paYYoJpjL7f+741zYcGZBhTY63JG0gRocxY
# RumaWNTbff4srN7NxExPA7/xeno1MkmpZx/Xp3xNgb+t+7vhmk1qWhYkQt/9OsHX
# MO5xUZYSu225RS2hghLiMIIS3gYKKwYBBAGCNwMDATGCEs4wghLKBgkqhkiG9w0B
# BwKgghK7MIIStwIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgbc5B
# usujF1MjxFzo7Y7Jt6Va3HKIeE/RsGwosx65FbECBmHlpN2+xRgTMjAyMjAxMjEw
# ODQzMzYuNjM0WjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# MC8GCSqGSIb3DQEJBDEiBCCx8HdD4JhZ3ad5IxXVlPSr8fgBgm6lnIx4eSa53/O8
# IjCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIGwdktetudtX/kn7Yq/AVYiB
...
# 4YTycdUpZFEpVCph3BUwDQYJKoZIhvcNAQELBQAEggEAZE0woPGKnmdIqN5ftFkR
# dm99sYagYsTKjxomhAyS3bAkS+4jUNFX2WZL/d0lENThgBzY9e6/6Ivlyb2c9cpl
# rHQH5snOJ4nVu5O5NI5gxqI+rq7EAdwwbO7xZTSYF/mNzYr7poU4yWr4tYnFJ/+5
# 0jMDcPFwApVr08VeDfUm7yoE5/qJRCVIhel3p2c7oyCDgUZ6I69GSQ5yTTzJfpu5
# MIVtOvdoiRR6Mv95M7dXKtTupVcHQktVCIcdnrh+s6V/Lu4IALR9mkdMMqQmhSYF
# lC+EtdscGa2CjOJcv7Jav04nplJUq2uytDo0gvlPqyxHSkA8gjBGNIXDPPmdjZjm
# ag==
