...
[CmdletBinding(DefaultParameterSetName='TestWithExistingAddr', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='TestWithExistingAddr', Mandatory, ValueFromPipelineByPropertyName)]
    ...
    [Parameter(ParameterSetName='TestWithNewAddr', Mandatory, ValueFromPipelineByPropertyName)]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Body')]
    [System.String]
    ${CompanyName},
    ...
    [Parameter(ParameterSetName='TestWithNewAddr', ValueFromPipelineByPropertyName)]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Body')]
    [System.String]
    ${City},
...
begin {
    try {
        ...
        $mapping = @{
            TestWithExistingAddr = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Test-CsOnlineLisCivicAddress';
            TestWithNewAddr = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Test-CsOnlineLisCivicAddress';
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCb2vWC8rC0/X07
# eX74Yc0Y6coafcDGJb3UcvDS+TO0tqCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKcxhBGD+2F+iuzmwAPmjPbvLgxj
# mM6f+f3iKMBv/cvxMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAJtHe+Et
# hF1j8x74oR4IlR/Yqp/djcjTdRPOFkQsmdfV8R0bKP9FUZpuLkj3Skcp4AK6RNwv
# jvpD+rA8+qSH0xd9hWACjZ7EjpLHf3Q+zIwI8N80hlvN5jnUcCNU6izbSYB2+4UZ
# TEHJGg3BWqF0FpRCt1SxdfnONWW+UE+YJ0Q0n53lMIdLN5j5dWHvBjjXELhacHay
# pgm4bDO1mY9Uw7rZYDUgQStlPvL1cVU7y6JuZCTCXwLKLfo65+hZ2NuNjeHbAzHx
# Uc1JPc7tKGsBVv9+3j0Jp2jxlNfWQ+lIC7IbVQPU02O7PTsPO2Omg8xrSdmtuF8Y
# J8lwpISp0jmXv32hghLlMIIS4QYKKwYBBAGCNwMDATGCEtEwghLNBgkqhkiG9w0B
# BwKgghK+MIISugIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgWlMS
# J0EZvHQoxwdUCN4SDXqxaRNTABkbd4IfIKFcTZ0CBmHloeC5mBgTMjAyMjAxMjEw
# ODQzNDEuODczWjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# EAEEMC8GCSqGSIb3DQEJBDEiBCDAyU/iW8jQEXQlw89lLhrLxfdhhe9DI5ulBs0i
# XQt/hDCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIKmQGuqMeaG/Jh/m1NxO
...
# gK8FvkwGdoZMrTfE1RPMsiwwDQYJKoZIhvcNAQELBQAEggEABMF35Zv5ZAhdW49I
# RczZu2F8VcAzu6DxkmSsK622G3WVz9f/IlsBXmb/mw+n06seJgIogTtSHmjBVgj9
# XqPyHs5Ifk+mBcIzEaN9gjKS1jaoG/d3fv2s4BOOKESHRMJ6hA/8ccsJIY/8iwfV
# tcqvPw9flW1j9S14aW8TwMsAWezJObzAm2tTB3ORUe5cegt90GcDBncyn/Lr6X4Z
# zje8DdnY/VBQzjWQjYGSgAxLNdzuJhieQ9TRLL516NwBCbjpJUGAz+7yS8ih13QW
# /6uT6K1Yk1R8+zO5preB0qQhiqxvdr5Hx7hqfklCH0EGUeZzOcplpIKZDW+umvMY
# 61g3oA==
